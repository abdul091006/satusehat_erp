...
public class frmUtama extends javax.swing.JFrame {
    ...
    private void prepareKhanzaJsonHeaders() {
        api.setKhanzaSourceRow(rs);
        headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_JSON);
        headers.add("X-Khanza-Payload-Format", "khanza_json");

        String authorization = api.AuthorizationKlinis();
        if (authorization != null && !authorization.trim().equals("")) {
            headers.add("Authorization", authorization);
        }
    }

    private boolean modeErpNextAktif() {
        try {
    ...
    private String idPasienKlinis(String nik) {
        if (modeErpNextAktif()) {
            return nik == null ? "" : nik.trim();
        }
        return cekViaSatuSehat.tampilIDPasien(nik);
    }

    private String idPraktisiKlinis(String nik) {
        if (modeErpNextAktif()) {
            return nik == null ? "" : nik.trim();
        }
    ...
    public frmUtama() {
        ...
        Tanggal1.setText("2026-06-07");
        Tanggal2.setText("2026-06-07");
        System.out.println("SATUSEHAT range aktif : "+Tanggal1.getText()+" s.d. "+Tanggal2.getText());
        ...
        System.out.println("SATUSEHAT DICOM router dilewati. Aktifkan Orthanc dulu kalau ingin kirim DICOM.");
        // kirimdicomrouter();
    }
    ...
    private void encounter() {
        try{
            ps=koneksi.prepareStatement(
                   ...
                   "reg_periksa.kd_pj,penjab.png_jawab,reg_periksa.status_bayar,pasien.nm_pasien,pasien.no_ktp,"+
            ...
            try {
                ...
                rs=ps.executeQuery();
                int jumlahDataEncounter = 0;
                int jumlahDataEncounterSiapKirim = 0;
                while(rs.next()){
                    jumlahDataEncounter++;
                    if((!rs.getString("no_ktp").equals(""))&&(!rs.getString("ktpdokter").equals(""))&&rs.getString("id_encounter").equals("")){
                        jumlahDataEncounterSiapKirim++;
                        try {
                            idpraktisi=idPraktisiKlinis(rs.getString("ktpdokter"));
                            idpasien=idPasienKlinis(rs.getString("no_ktp"));
                            if(idpraktisi.equals("")||idpasien.equals("")){
                                TeksArea.append("Lewati Encounter "+rs.getString("no_rawat")+" : idpraktisi/idpasien SatuSehat kosong\n");
                                continue;
                            }
                            try{
                                prepareKhanzaJsonHeaders();
                                json = "{" +
                                ...
                                json = api.toKhanzaFlatJson(rs, "", "POST", link+"/Encounter");
                        ...
                        try {
                            ...
                            try{
                                ...
                                json = api.toKhanzaFlatJson(rs, "", "PUT", link+"/Encounter/"+rs.getString("id_encounter"));
                                TeksArea.append("Request JSON : "+json+"\n");
                                requestEntity = new HttpEntity(json,headers);
                ...
                if(jumlahDataEncounter==0){
                    System.out.println("SATUSEHAT Encounter : tidak ada data pada tanggal "+Tanggal1.getText()+" s.d. "+Tanggal2.getText()+". Jalankan satusehat_staging_dummy_seed.sql dulu.");
                }else if(jumlahDataEncounterSiapKirim==0){
                    System.out.println("SATUSEHAT Encounter : ada "+jumlahDataEncounter+" data, tapi tidak ada yang siap POST. Kemungkinan id_encounter sudah ada atau NIK kosong.");
                }
            } catch (Exception ex) {
            ...
            try {
                ...
                while(rs.next()){
                    if((!rs.getString("no_ktp").equals(""))&&(!rs.getString("ktppraktisi").equals(""))&&rs.getString("satu_sehat_observationttvsuhu").equals("")){
                        try {
                            idpraktisi=idPraktisiKlinis(rs.getString("ktppraktisi"));
                            idpasien=idPasienKlinis(rs.getString("no_ktp"));
                            if(idpraktisi.equals("")||idpasien.equals("")||rs.getString("id_encounter").equals("")){
                                TeksArea.append("Lewati QuestionnaireResponse "+rs.getString("no_resep")+" : idpraktisi/idpasien/id_encounter SatuSehat kosong\n");
                                continue;
                            }
                            try{
                                prepareKhanzaJsonHeaders();
                                ...
                                json = api.toKhanzaFlatJson(rs, "", "POST", link+"/Observation");
                                TeksArea.append("Request JSON : "+json+"\n");
                                requestEntity = new HttpEntity(json,headers);
                    ...
                    if((!rs.getString("no_ktp").equals(""))&&(!rs.getString("ktppraktisi").equals(""))&&rs.getString("satu_sehat_clinicalimpression").equals("")){
                        try {
                            ...
                            try{
                                ...
                                json = api.toKhanzaFlatJson(rs, "", "POST", link+"/ClinicalImpression");
                                TeksArea.append("Request JSON : "+json+"\n");
                                requestEntity = new HttpEntity(json,headers);
                    ...
                    if((!rs.getString("no_ktp").equals(""))&&(!rs.getString("ktppraktisi").equals(""))&&rs.getString("id_immunization").equals("")){
                        try {
                            ...
                            try{
                                ...
                                json = api.toKhanzaFlatJson(rs, "", "POST", link+"/Immunization");
                                TeksArea.append("Request JSON : "+json+"\n");
                                requestEntity = new HttpEntity(json,headers);
                    ...
                    if((!rs.getString("no_ktp").equals(""))&&rs.getString("id_procedure").equals("")){
                        try {
                            ...
                            try{
                                ...
                                json = api.toKhanzaFlatJson(rs, "", "POST", link+"/Procedure");
                                TeksArea.append("Request JSON : "+json+"\n");
                                requestEntity = new HttpEntity(json,headers);
                    ...
                    if((!rs.getString("no_ktp").equals(""))&&rs.getString("id_condition").equals("")){
                        try {
                            ...
                            try{
                                ...
                                json = api.toKhanzaFlatJson(rs, "", "POST", link+"/Condition");
                                TeksArea.append("Request JSON : "+json+"\n");
                                requestEntity = new HttpEntity(json,headers);
                    ...
                    if((!rs.getString("no_ktp").equals(""))&&(!rs.getString("ktppraktisi").equals(""))&&rs.getString("satu_sehat_diet").equals("")){
                        try {
                            ...
                            try{
                                ...
                                json = api.toKhanzaFlatJson(rs, "", "POST", link+"/Composition");
                                TeksArea.append("Request JSON : "+json);
                                requestEntity = new HttpEntity(json,headers);
    ...
    private void medication(){
        try{
            ps=koneksi.prepareStatement(
                   ...
                   "where ifnull(satu_sehat_medication.id_medication,'')<>'' and ( "+
                   "exists (select 1 from resep_obat inner join reg_periksa on reg_periksa.no_rawat=resep_obat.no_rawat "+
                   "inner join resep_dokter on resep_dokter.no_resep=resep_obat.no_resep "+
                   "where resep_dokter.kode_brng=satu_sehat_mapping_obat.kode_brng and reg_periksa.status_bayar='Sudah Bayar' "+
                   "and reg_periksa.tgl_registrasi between ? and ?) "+
                   "or exists (select 1 from resep_obat inner join reg_periksa on reg_periksa.no_rawat=resep_obat.no_rawat "+
                   ...
                   "where resep_dokter_racikan_detail.kode_brng=satu_sehat_mapping_obat.kode_brng and reg_periksa.status_bayar='Sudah Bayar' "+
                   "and reg_periksa.tgl_registrasi between ? and ?) "+
                   "or exists (select 1 from detail_pemberian_obat inner join reg_periksa on reg_periksa.no_rawat=detail_pemberian_obat.no_rawat "+
                   "where detail_pemberian_obat.kode_brng=satu_sehat_mapping_obat.kode_brng and reg_periksa.status_bayar='Sudah Bayar' "+
                   "and reg_periksa.tgl_registrasi between ? and ?) "+
                   ") "+
            ...
            try {
                ...
                ps.setString(5,Tanggal1.getText());
                ps.setString(6,Tanggal2.getText());
                rs=ps.executeQuery();
                while(rs.next()){
                    if(!rs.getString("id_medication").equals("")){
                        try{
                            ...
                            json = api.toKhanzaFlatJson(rs, "", "PUT", link+"/Medication/"+rs.getString("id_medication"));
                            TeksArea.append("Request JSON : "+json);
                            requestEntity = new HttpEntity(json,headers);
                    ...
                    if((!rs.getString("no_ktp").equals(""))&&(!rs.getString("ktppraktisi").equals(""))&&rs.getString("id_medicationrequest").equals("")){
                        try {
                            ...
                            try{
                                ...
                                json = api.toKhanzaFlatJson(rs, "", "POST", link+"/MedicationRequest");
                                TeksArea.append("Request JSON : "+json);
                                requestEntity = new HttpEntity(json,headers);
                    ...
                    if((!rs.getString("no_ktp").equals(""))&&(!rs.getString("ktppraktisi").equals(""))&&rs.getString("id_medicationdispanse").equals("")){
                        try {
                            ...
                            try{
                                ...
                                json = api.toKhanzaFlatJson(rs, "", "POST", link+"/MedicationDispense");
                                TeksArea.append("Request JSON : "+json);
                                requestEntity = new HttpEntity(json,headers);
                    ...
                    if((!rs.getString("no_ktp").equals(""))&&(!rs.getString("ktpdokter").equals(""))&&rs.getString("id_servicerequest").equals("")){
                        try {
                            ...
                            try{
                                ...
                                json = api.toKhanzaFlatJson(rs, "", "POST", link+"/ServiceRequest");
                                TeksArea.append("Request JSON : "+json);
                                requestEntity = new HttpEntity(json,headers);
                    ...
                    if((!rs.getString("no_ktp").equals(""))&&rs.getString("id_specimen").equals("")){
                        try {
                            ...
                            try{
                                ...
                                json = api.toKhanzaFlatJson(rs, "", "POST", link+"/Specimen");
                                TeksArea.append("Request JSON : "+json);
                                requestEntity = new HttpEntity(json,headers);
                    ...
                    if((!rs.getString("no_ktp").equals(""))&&(!rs.getString("ktpdokter").equals(""))&&rs.getString("id_diagnosticreport").equals("")){
                        try {
                            ...
                            try{
                                ...
                                json = api.toKhanzaFlatJson(rs, "", "POST", link+"/DiagnosticReport");
                                TeksArea.append("Request JSON : "+json);
                                requestEntity = new HttpEntity(json,headers);
                    ...
                    if((!rs.getString("no_ktp").equals(""))&&(!rs.getString("ktpdokter").equals(""))&&rs.getString("id_servicerequest").equals("")){
                        try {
                            ...
                            try{
                                ...
                                response = root.path("id");
                                if(!response.asText().equals("")){
                                    Sequel.menyimpan2("satu_sehat_servicerequest_lab_mb","?,?,?,?","No.Rawat",4,new String[]{
                                        rs.getString("noorder"),rs.getString("kd_jenis_prw"),rs.getString("id_template"),response.asText()
                                    });
                                }
                            }catch(Exception ea){
                    ...
                    if((!rs.getString("no_ktp").equals(""))&&(!rs.getString("ktppraktisi").equals(""))&&rs.getString("satu_sehat_careplan").equals("")){
                        try {
                            ...
                            try{
                                ...
                                json = api.toKhanzaFlatJson(rs, "", "POST", link+"/CarePlan");
                                TeksArea.append("Request JSON : "+json);
                                requestEntity = new HttpEntity(json,headers);
                    ...
                    if((!rs.getString("no_ktp").equals(""))&&rs.getString("id_medicationstatement").equals("")){
                        try {
                            ...
                            try{
                                ...
                                json = api.toKhanzaFlatJson(rs, "", "POST", link+"/MedicationStatement");
                                TeksArea.append("Request JSON : "+json);
                                requestEntity = new HttpEntity(json,headers);
                    ...
                    if((!rs.getString("no_ktp").equals(""))&&(!rs.getString("ktppraktisi").equals(""))&&rs.getString("id_questionresponse").equals("")){
                        try {
                            ...
                            try{
                                ...
                                json = api.toKhanzaFlatJson(rs, "", "POST", link+"/QuestionnaireResponse");
                                TeksArea.append("Request JSON : "+json+"\n");
                                requestEntity = new HttpEntity(json,headers);
                        ...
                        try {
                            ...
                            if(!category.equals("")){
                                ...
                                try{
                                    ...
                                    json = api.toKhanzaFlatJson(rs, "", "POST", link+"/AllergyIntolerance");
                                    TeksArea.append("Request JSON : "+json);
                                    requestEntity = new HttpEntity(json,headers);
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    if(root==null || !root.isArray()){
                        System.out.println("Notif : Orthanc tidak mengembalikan daftar study, proses kirim DICOM dilewati untuk No.RM "+rs.getString(1));
                        continue;
                    }
