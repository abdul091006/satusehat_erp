...
public class koneksiDB {
    ...
    public static String ERPNEXTSATUSEHATENABLE(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("ERPNEXTSATUSEHATENABLE");
        }catch(Exception e){
            var="true";
        }
        if(var==null){
    ...
    public static String ERPNEXTSATUSEHATURL(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("ERPNEXTSATUSEHATURL");
        }catch(Exception e){
            var="";
        }
        return var;
    ...
    public static String ERPNEXTSATUSEHATAPIKEY(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("ERPNEXTSATUSEHATAPIKEY");
            try{
                var=EnkripsiAES.decrypt(var);
            }catch(Exception e){
                // Allow plain api_key:api_secret for ERPNext integration testing.
            }
        }catch(Exception e){
            var="";
        }
